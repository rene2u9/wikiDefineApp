...
public class wikiFileDumpParser {
    private tm16wiki.wikidefine.helperClasses.db db;
    private int pages = 0;
    ...
    public wikiFileDumpParser(int threads, int maximum, boolean printstats, boolean verbose, String path, tm16wiki.wikidefine.helperClasses.db db) {
            ...
            try {
                ...
                while ((line = file.readLine()) != (null) && pos < chunksize * (id + 1) && pages-prefiltered<=max) {
                    ...
                    if (line.contains("<page>")) { //line.contains("<page id=") { //for preprocessed pages
                        ...
                        if (!reject) {
                            String article;
                            article = xml.getTagValue(page, "text");
